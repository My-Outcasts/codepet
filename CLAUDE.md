...
- Every typed chat message fans out to `companyChat` and `virtualCompanyRun` in parallel; the router's escape hatch decides whether the founder ever sees a room. Measured ~$0.20 per convened decision, ~$0.005 otherwise
