    ...
    var body: some Scene {
        WindowGroup {
            ContentView()
                ...
                .environmentObject(reflectionComposition.dictionaryStore)
                .environmentObject(reflectionComposition.dictionaryEnricher)
                .environmentObject(reflectionComposition.agencyLog)
